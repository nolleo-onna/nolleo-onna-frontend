...
1. **[next.md](./next.md)를 읽으세요.** 어디까지 진행됐고 다음에 뭘 할지, 지금 막혀 있는 게 뭔지 적혀 있습니다.
2. 지나온 기록이 필요하면 [PROGRESS.md](./PROGRESS.md)를 봅니다.
3. **작업을 끝내면 next.md를 갱신**하고(다음 할 일·막힌 것), 끝낸 일은 PROGRESS.md 맨 위 섹션에 한 줄 추가해 같이 커밋합니다.
