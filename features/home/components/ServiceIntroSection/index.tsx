...
export default function ServiceIntroSection() {
  return (
    <section
        ...
        style={{ background: "linear-gradient(135deg, #0d0d14 0%, #1a0a1a 100%)" }}
    >
      <div className="px-8 md:px-16 py-16 md:py-20">
        {/* 헤더 */}
        <div className="text-center mb-12">
          <span className="text-xs font-semibold text-pink-400 tracking-widest uppercase block mb-3">
            왜 놀러온나인가요
          </span>
          <h2 className="text-2xl md:text-3xl font-bold text-white">
            왜 <span className="text-pink-400">놀러온나</span>인가요?
          </h2>
        </div>
