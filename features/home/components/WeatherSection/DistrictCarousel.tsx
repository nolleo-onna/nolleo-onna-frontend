    ...
    <div>
      ...
      >
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-sky-400 to-blue-500 p-4 md:p-5 text-white"
        >
        ...
        <motion.div
          variants={cardVariants}
          className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 p-4 md:p-5 text-white"
        >
        ...
        <motion.div
          variants={cardVariants}
          className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-400 to-pink-500 p-4 md:p-5 text-white"
        >
          ...
          <motion.p
            key={`congestion-${summary.district}`}
            initial={{ opacity: 0, y: 4 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.3, ease: "easeOut" }}
            className="text-2xl md:text-3xl font-bold tracking-tight"
