    ...
    <div className="absolute bottom-2 left-2 right-2 z-10 lg:bottom-4 lg:left-4 lg:right-4">
      ...
      >
        ...
        <a
          ...
          className="flex items-center justify-center gap-1.5 border-t border-gray-50 py-2 text-[12px] font-semibold text-ocean-600 transition-colors hover:bg-ocean-50/60"
        >
